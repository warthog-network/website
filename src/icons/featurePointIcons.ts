...
export const featurePointIcons: Record<FeaturePointIconName, string> = {
  ...
  // Liquidity droplet (continuous pool) with order-book levels inside — hybrid liquidity
  hybridLiquidity: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M12 3.2C12 3.2 5.2 11 5.2 15.2a6.8 6.8 0 0 0 13.6 0C18.8 11 12 3.2 12 3.2Z" stroke="${BRAND}" stroke-width="1.8" stroke-linejoin="round"/><path d="M8.2 12.5h7.6M8.6 15.2h6.8M9.5 17.8h5" stroke="${BRAND}" stroke-width="1.6" stroke-linecap="round"/></svg>`,
