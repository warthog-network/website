...
<div className="overflow-x-auto my-4 md:mx-0 md:px-0 [max-width:768px]:-mx-[100vw] [max-width:768px]:left-1/2 [max-width:768px]:w-screen [max-width:768px]:-translate-x-1/2 [max-width:768px]:relative">
